...
import { deleteUser, getAllUsers, softDeleteUser } from "../../actions/userAction";
...
function User() {
  ...
  return (
    <div>
      ...
      ) :<UsersTable items={users} head="Name" handleDelete={handleDeleteUser} handleClick={handleClick}/>}
    </div>
  );
}
