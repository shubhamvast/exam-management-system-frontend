    ...
    <>
      <div className=" my-1  flex items-center justify-between ">
        ...
        <div className="h-full w-2/3 flex flex-col justify-center">
          <h4 className="w-full  whitespace-normal">{printText(user.firstName + " " + user.lastName)}</h4>
          <p className="text-sm font-semibold">{printText(user.role?.toLowerCase())}</p>
        </div>
      </div>
