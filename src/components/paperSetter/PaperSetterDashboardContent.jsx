...
function PaperSetterDashboardContent() {
  ...
  return (
    <div className="px-4">
      <div className="flex justify-between items-center   pt-4 ">
        ...
        <NavLink to={location.pathname==="/paperSetter/dashboard/papers"?"/paperSetter/add/paper":"/paperSetter/add/questionBank"}>
          <MdAdd
...
export default PaperSetterDashboardContent;
